...
This is a git repository of the source files for the book A Treatise of Taxes and Contributions
Shewing the nature and measures of crown-lands, assessements, customs, poll-moneys, lotteries, benevolence, penalties, monopolies, offices, tythes, raising of coins, harth-money, excize, &c.; with several intersperst discourses and digressions concerning warres, the church, universities, rents & purchases, usury & exchange, banks & lombards, registries for conveyances, beggars, ensurance, exportation of money [&] wool, free-ports, coins, housing, liberty of conscience, &c.; the same being frequently applied to the present state and affairs of Ireland. by William Petty, Sir. This book is Public domain in the USA., see the LICENSE file for details. 
...
Technical details
=================
The main source file for this book will be a file with a name containing `61588` with a file extension (ex. `.txt`, `.rst`, `.tei`, `.tex`). Some books also contain generated ebooks, html versions, and images/figures from the text as image files. Eventually, there will be generated ebooks in the downloads area.
